...
class RoutinesNotifier extends Notifier<List<Routine>> {
  ...
  void _preloadDefaults(Box<Routine> box) {
    final defaults = [
      ...
      Routine(
        ...
        exerciseIds: ['ex_1', 'ex_6', 'ex_4', 'ex_3', 'ex_7', 'ex_16', 'ex_8', 'ex_23', 'ex_21', 'ex_15'],
      ),
      Routine(
        id: 'r_1b',
        ...
        exerciseIds: ['ex_2', 'ex_4', 'ex_3', 'ex_18', 'ex_22', 'ex_17', 'ex_25', 'ex_27'],
      ),
      Routine(
        id: 'r_1c',
        ...
        exerciseIds: ['ex_1', 'ex_6', 'ex_4', 'ex_3', 'ex_9', 'ex_7', 'ex_10', 'ex_11', 'ex_12'],
      ),
      // ---- SCHEDA 2 ----
      Routine(
        id: 'r_2a',
        ...
        exerciseIds: ['ex_1', 'ex_2', 'ex_6', 'ex_4', 'ex_3', 'ex_9', 'ex_24', 'ex_13', 'ex_29', 'ex_14'],
      ),
      Routine(
        id: 'r_2b',
        ...
        exerciseIds: ['ex_2', 'ex_4', 'ex_3', 'ex_19', 'ex_20', 'ex_23', 'ex_26', 'ex_28', 'ex_5'],
      ),
      Routine(
        id: 'r_2c',
        ...
        exerciseIds: ['ex_1', 'ex_6', 'ex_4', 'ex_3', 'ex_7', 'ex_30', 'ex_31', 'ex_21', 'ex_11'],
      ),
    ];
  ...
  void updateRoutineConfigs(String routineId, Map<String, ExerciseConfig> configs) {
    final box = Hive.box<Routine>('routines');
